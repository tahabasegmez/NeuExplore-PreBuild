...
namespace CustomRotationNS
{
    public class CustomRotation : MonoBehaviour
    {
        ...
        private UnityEngine.XR.Interaction.Toolkit.Interactables.XRGrabInteractable XRComponent = null;

        public void Start()
        {
            XRComponent = gameObject.GetComponent<UnityEngine.XR.Interaction.Toolkit.Interactables.XRGrabInteractable>();
        }
        void Update()
        {
